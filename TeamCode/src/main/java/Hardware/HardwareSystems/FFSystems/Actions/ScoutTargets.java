    ...
    public static SCOUTTarget getTarget(ScoutSystem.SCOUT_ALLIANCE alliance, ScoutSystem.SCOUT_TARGET target){
        if(alliance == ScoutSystem.SCOUT_ALLIANCE.RED){
            switch (target){
                ...
                case SHARED:
                    return new SCOUTTarget(Angle.degrees(70), Angle.degrees(10), 13);
            }
        }else{
            switch (target){
                case ALLIANCE_HIGH:
                    return new SCOUTTarget(Angle.degrees(68), Angle.degrees(32), 42.5);
                case ALLIANCE_HIGH_AUTO:
                    return new SCOUTTarget(Angle.degrees(68), Angle.degrees(27), 42.5);
                case ALLIANCE_MID:
